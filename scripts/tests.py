...
def test_mm9_e2e():
    ...
    for name, val in [
        ...
        ("MATTERMOST_ADMIN_PASSWORD", "***REMOVED***"),
        ("MATTERMOST_BOT_PASSWORD", "***REMOVED***"),
        ("MATTERMOST_TEST_PASSWORD", "***REMOVED***"),
    ]:
...
def test_fn_12_file_upload():
    ...
    MM = "http://mattermost:8065"
    admin_data = json.dumps({"login_id": "lucasbasquerotto", "password": "***REMOVED***"}).encode()
