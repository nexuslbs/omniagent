                ...
                select! {
                    ...
                    envelope = receiver.recv() => {
                        ...
                        let params = DeliverParams {
                            ...
                            reply_to_message_id: envelope.reply_to_message_id.clone(),
                                                        ...
                                                        Ok(Some(channel)) => {
                                                            ...
                                                            if inbound.text.starts_with("//profile") {
                                                                ...
                                                                crate::db::types::ThreadCauseParams {
                                                                    ...
                                                                    // No explicit plan preference: the prompt plugin decides at
                                                                    // runtime based on its complexity config (message length +
